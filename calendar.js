...
// date
var currentTime = moment(octDate,dateFormat); // current date & time
//currentTime = moment();
...
currentTime = moment(octDate,dateFormat);
//currentTime = moment();
...
//date
var startOfMonthLoop = moment(octDate,dateFormat).startOf('month');
//currentTime = moment();
